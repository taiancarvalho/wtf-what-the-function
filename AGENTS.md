...
- traduzir o projeto para linguagem humana e alimentar o painel — leia e siga `.claude/skills/wtf-mapear/SKILL.md`
- descobrir e manter onde cada coisa mora (`MAPA.md`) — leia e siga `.claude/skills/wtf-pastas/SKILL.md`
- descobrir qual documento vale hoje sobre cada assunto — leia e siga `.claude/skills/wtf-documentos/SKILL.md`
- escrever as regras do que NÃO se faz neste projeto — leia e siga `.claude/skills/wtf-guardrails/SKILL.md`
