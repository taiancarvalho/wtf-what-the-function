...
const pt: Dic = {
  ...
  'pergunta.aviso.titulo': 'Esta pergunta usa créditos da sua chave',
  'pergunta.aviso.texto':
    'A resposta vem de um modelo de IA pago com a chave que você configurou, e cada pergunta consome um pouco desses créditos. Nada além do que você perguntar é enviado. O resto do WTF continua funcionando sem gastar nada.',
...
const en: Dic = {
  ...
  'pergunta.aviso.titulo': 'This question uses credits from your key',
  'pergunta.aviso.texto':
    'The answer comes from an AI model paid for with the key you set up, and each question spends a little of those credits. Nothing beyond what you ask is sent. The rest of WTF keeps working without spending anything.',
...
const es: Dic = {
  ...
  'pergunta.aviso.titulo': 'Esta pregunta usa créditos de tu clave',
  'pergunta.aviso.texto':
    'La respuesta viene de un modelo de IA pagado con la clave que configuraste, y cada pregunta consume un poco de esos créditos. No se envía nada más que lo que preguntes. El resto de WTF sigue funcionando sin gastar nada.',
