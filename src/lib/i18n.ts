...
const pt: Dic = {
  ...
  'estado.tested': 'Tem teste escrito',
  ...
  'estado.tested.sentido': 'Existe um teste escrito para esta parte. O WTF não executou esse teste — ele só viu que ele existe.',
  ...
  'versao.titulo': 'Versão do WTF',
  'versao.nota': 'Qual versão está instalada, e se já existe uma mais nova.',
  'versao.instalada': 'Instalada',
  'traduzir.naFila': 'Traduzindo aos poucos: faltam {n}. O restante aparece nas próximas aberturas.',
  'config.desatualizados': 'O WTF foi atualizado e {n} aqui ficaram para trás. A IA ainda está lendo a versão antiga.',
  'config.atualizarArquivos': 'Atualizar os arquivos',
  'config.atualizando': 'Atualizando…',
  'versao.soNoApp': 'Saber a versão só funciona dentro do aplicativo.',
  'versao.emDia': 'Você está na versão mais nova.',
  'versao.temNova': 'Há uma versão mais nova do WTF.',
  'versao.temNovaNota': 'Para atualizar, rode no terminal, dentro da pasta do WTF:',
  'versao.travado': 'Há mudanças não salvas na pasta do WTF, então a atualização está travada.',
  'versao.travadoNota': 'Isso é proposital: atualizar por cima apagaria o que está lá.',
  'versao.semGit': 'Este WTF não veio de um clone, então não dá para atualizar por aqui.',
  'versao.desconhecido': 'Não deu para saber se há versão nova agora.',
...
const en: Dic = {
  ...
  'estado.tested': 'Has a test written',
  ...
  'estado.tested.sentido': 'A test exists for this part. WTF did not run that test — it only saw that it is there.',
  ...
  'versao.titulo': 'WTF version',
  'versao.nota': 'Which version is installed, and whether a newer one exists.',
  'versao.instalada': 'Installed',
  'traduzir.naFila': 'Translating gradually: {n} to go. The rest shows up next time you open it.',
  'config.desatualizados': 'WTF was updated and {n} here fell behind. The AI is still reading the old version.',
  'config.atualizarArquivos': 'Update the files',
  'config.atualizando': 'Updating…',
  'versao.soNoApp': 'Checking the version only works inside the app.',
  'versao.emDia': 'You are on the newest version.',
  'versao.temNova': 'A newer version of WTF is available.',
  'versao.temNovaNota': 'To update, run this in the terminal, inside the WTF folder:',
  'versao.travado': 'There are unsaved changes in the WTF folder, so updating is blocked.',
  'versao.travadoNota': 'That is on purpose: updating over them would erase what is there.',
  'versao.semGit': 'This WTF did not come from a clone, so it cannot be updated here.',
  'versao.desconhecido': 'Could not check for a newer version right now.',
...
const es: Dic = {
  ...
  'estado.tested': 'Tiene prueba escrita',
  ...
  'estado.tested.sentido': 'Existe una prueba escrita para esta parte. WTF no ejecutó esa prueba — solo vio que existe.',
  ...
  'skills.salvando': 'Aplicando…',
  'versao.titulo': 'Versión de WTF',
  'versao.nota': 'Qué versión está instalada, y si ya existe una más nueva.',
  'versao.instalada': 'Instalada',
  'traduzir.naFila': 'Traduciendo poco a poco: faltan {n}. El resto aparece en las próximas aperturas.',
  'config.desatualizados': 'WTF fue actualizado y {n} aquí quedaron atrás. La IA sigue leyendo la versión antigua.',
  'config.atualizarArquivos': 'Actualizar los archivos',
  'config.atualizando': 'Actualizando…',
  'versao.soNoApp': 'Saber la versión solo funciona dentro de la aplicación.',
  'versao.emDia': 'Está en la versión más nueva.',
  'versao.temNova': 'Hay una versión más nueva de WTF.',
  'versao.temNovaNota': 'Para actualizar, ejecute en la terminal, dentro de la carpeta de WTF:',
  'versao.travado': 'Hay cambios sin guardar en la carpeta de WTF, así que la actualización está bloqueada.',
  'versao.travadoNota': 'Es a propósito: actualizar por encima borraría lo que está ahí.',
  'versao.semGit': 'Este WTF no vino de un clon, así que no se puede actualizar aquí.',
  'versao.desconhecido': 'No se pudo comprobar si hay una versión más nueva ahora.',
