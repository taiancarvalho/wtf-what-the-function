...
<!-- wtf:idioma -->
Escreva SEMPRE em português do Brasil. Isto vale para o `assunto`, o `resumo` e o `porque` de cada entrada de `.wtf/docs.json`, e para o resumo final que você dá em conversa, mesmo que ela esteja em outra língua. Os nomes dos arquivos e os caminhos ficam como estão no disco.
<!-- /wtf:idioma -->
